...
tags: opportunities graduate-students research
categories: opportunities
related_posts: false
---

I am currently seeking motivated graduate students to join my research group at the University of South Alabama, working at the intersection of cybersecurity, robotics, and hardware security.
...
- Continued to PhD programs at top universities
...
- Adversarial defense methods for autonomous systems
- Digital twin development for robot testing
...
- Background in digital signal processing or hardware design

## How to Apply

Interested students should:

1. **Review our publications** to understand our research focus
2. **Email me** with:
   - Your CV/resume
   - Transcripts (unofficial are fine initially)
   - Brief statement of research interests (1 page)
   - GRE scores (if available)
3. **Apply to the University of South Alabama** School of Computing graduate program

## Application Deadlines

- **Priority consideration**: February 1 for Fall admission
- **Regular admission**: Rolling basis until program fills
- **International students**: Apply early to allow time for visa processing

## Contact

For questions about research opportunities or the application process, contact me at georgewclark@southalabama.edu.

I look forward to hearing from motivated students ready to tackle challenging problems in cybersecurity and robotics!
